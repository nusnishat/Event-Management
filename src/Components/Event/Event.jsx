...
const Event = ({eventt}) => {
    ...
    return (
        <div className='space-y-2 my-4 '>
            ...
            <div className='flex '>
                <SlCalender className=' me-2 text-cyan-500 font-extrabold text-xl' />
                <p className='text-md text-zinc-600'>{date}</p>
            </div>
            <div className='flex '>
                <MdLocationOn className=' me-2 text-cyan-500 font-extrabold text-xl' />
                <p className='text-md text-zinc-600'>{location}</p>
            </div>
            <div className='flex '>
                <FaPeopleGroup className=' me-2 text-cyan-500 font-extrabold text-xl' />
