...
const AboutUs = () => {
    const teamMembers = [
      ...
      const whyChooseUsItems = [
        {
           text: 'The Events Specialists', 
          description:"Our team of seasoned event specialists combines creative vision with meticulous attention to detail, ensuring every aspect of your event is flawlessly executed. With a passion for excellence and a client-centric approach, we turn your vision into an unforgettable experience.",
          icon: () => <span className="material-icons">group</span>, color: 'text-blue-500'
         },
        { 
          text: 'Dedicated Venues & Arrangements', 
          description:"We offer exclusive access to dedicated venues and handle all arrangements with precision, ensuring your event takes place in the perfect setting with seamless coordination. Our specialists meticulously manage every detail, from venue selection to setup, guaranteeing a flawless and memorable experience.",
          icon: () => <span className="material-icons">person</span>, color: 'text-green-500' 
        },
        { 
          text: 'Affordable Pricing',
          description:"We provide exceptional event planning services with a focus on affordable pricing, ensuring you receive top-quality results without exceeding your budget. Our transparent and competitive rates offer excellent value while delivering the excellence and attention to detail your event deserves.",
          icon: () => <span className="material-icons">attach_money</span>, color: 'text-yellow-500' 
        },
        {
           text: 'All Types of Events',
           description:"We cater to all types of events, offering tailored solutions for everything from intimate gatherings to large celebrations. Our flexible and affordable pricing ensures you get exceptional service and quality for every occasion, regardless of size or scope.",
           icon: () => <span className="material-icons">support</span>, color: 'text-red-500' 
        },
      ];
  return (
    <div className="leading-loose text-justify">
      ...
      <div className="lg:flex flex-row-reverse gap-8 md:gap-20 py-20 px-8 md:px-24 ">
      <div>
          {/* Our Goals Section */}
          ...
          <div className="w-full mt-8">
            {whyChooseUsItems.map((item, index) => (
              <div key={index} className="collapse collapse-plus bg-base-200 mb-4 rounded-lg shadow-md">
                ...
                <div className="collapse-title text-xl font-semibold flex items-center">
                  {/* <item.icon className={`mr-2 ${item.color}`} /> */}
                  {item.text}
                </div>
                <div className="collapse-content">
                  <p className="text-gray-500 pb-4 px-4">
                  {item.description}
                  </p>
                </div>
              </div>
